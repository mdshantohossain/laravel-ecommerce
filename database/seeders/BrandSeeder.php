    ...
    public function run(): void
    {
        $brands = [
            0 => [
                ...
                'image' => 'email/assets/img/brand-images/brand-1.png',
                'status' => 1,
            ],
            1 => [
                'name' => 'Design Hub',
                'description' => 'This is Design Hub brand description',
                'image' => 'email/assets/img/brand-images/brand-2.png',
                'status' => 1,
            ],
            2 => [
                'name' => 'Travel',
                'description' => 'This is Travel brand description',
                'image' => 'email/assets/img/brand-images/brand-3.png',
                'status' => 1,
            ],
            4 => [
                'name' => 'Mock up',
            ...
            5 => [
                ...
                'image' => 'email/assets/img/brand-images/brand-5.png',
                'status' => 1,
            ],
            6 => [
                'name' => 'Shutter Speed',
