                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{asset($product->image)}}" width="100%" style="border-radius: 8px" alt="product image">
                                            </figure>
                                        ...
                                        <div class="slider-nav-thumbnails pl-15 pr-15">
                                            ...
                                            <div><img src="{{asset($otherImage->image)}}"  width="100" height="80" alt="product image"></div>
                                            @endforeach
                                        </div>
                                    </div>
                                    <!-- End Gallery -->
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li class="mb-5">Tags: {{ $product->category->name }}, {{ $product->subCategory->name }}</li>
                                            <li>Availability:<span class="in-stock ml-5 {{ $product->stoke_amount == 0 ? 'text-danger' : 'text-success' }}">{{ !empty($product->stoke_amount) ? $product->stoke_amount. ' Items In Stock' : 'Out Of Stoke' }} </span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ route('product.detail', $product->slug) }}" tabindex="0">
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{ route('product.detail', $product->slug) }}" tabindex="0">{{ $product->name }}</a></h2>
