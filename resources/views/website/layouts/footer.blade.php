                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        <div class="col flex-horizontal-center">
                            <img class="icon-email" src="{{asset('/')}}website/assets/imgs/theme/icons/icon-email.svg"
                                 alt="">
                        ...
                        <div class="col-md-8 col-lg-12">
                            ...
                            <div class="download-app wow fadeIn animated">
                                ...
                                <a href="#" class="hover-up"><img
                                        src="{{asset('/')}}website/assets/imgs/theme/google-play.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                            <p class="mb-20 wow fadeIn animated">Secured Payment Gateways</p>
                            <img class="wow fadeIn animated"
                                 src="{{asset('/')}}website/assets/imgs/theme/payment-method.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
